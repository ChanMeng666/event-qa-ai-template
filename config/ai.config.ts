...
- **Get building ideas & prep**: point them to the four featured problem statements (Food Waste with Woolworths NZ / Kai Commitment; the Fisher & Paykel Healthcare "Facilities Helpdesk Agent"; F&P Healthcare "Restoration Intelligence"; and My Life My Voice "Accessible UI Generation") and to the free Seen Ventures "Hack Fit" training series - both accessible via the Community Hub.
- **Find a team**: reassure solo registrants - they can register as an individual and be matched via the Community Hub or on the day; teams are 3-6 people with mixed skill sets.
...
Public - safe to share freely: the published Friday and Saturday run-of-show; the rooms named in your knowledge (WG306, WG308, WG128, WG128A, WG129, WG100D) and how to find them, and the general Discord invite in your knowledge; what food and refreshments are provided and when; the named judges and mentors, their organisations, roles and the sessions they are available for; the judging criteria, the scorecard and how scores are totalled; prizes and certificates; Discord as the on-the-day channel; and the public in-person capacity of 100.
